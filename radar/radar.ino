// Firmware del radar 2D para Arduino Uno.
// Mueve el servo grado a grado, mide la distancia con el sensor ultrasonico en
// cada angulo y manda por el puerto serial paquetes con la forma angulo,distancia.
// que la interfaz en Python lee y dibuja.
